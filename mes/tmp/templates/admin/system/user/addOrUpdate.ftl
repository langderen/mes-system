        ...
        <form class="layui-form splayui-form">
            <div class="layui-row">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md6">
                    ...
                    <div class="layui-form-item">
                        <label for="js-password" class="layui-form-label<#if !(result?? && result.id??)> sp-required</#if>">密码
                        </label>
                        <div class="layui-input-inline">
                            <input type="password" id="js-password" name="password" lay-verify="<#if !(result?? && result.id??)>required</#if>" autocomplete="off" class="layui-input" value="">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label for="js-repassword" class="layui-form-label<#if !(result?? && result.id??)> sp-required</#if>">确认密码
                        </label>
                        <div class="layui-input-inline">
                            <input type="password" id="js-repassword" name="repassword" lay-verify="<#if !(result?? && result.id??)>required</#if>" autocomplete="off" class="layui-input" value="">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select id="js-dept-id" name="deptId" lay-verify="">
