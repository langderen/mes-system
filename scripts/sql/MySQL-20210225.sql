...
INSERT INTO `sp_sys_menu` VALUES ('107', 'group', '班组管理', '/admin/sys/group/list-ui', '10', '3', 7, '0', 'user:add', 'fa fa-group', '', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_menu` VALUES ('108', 'equipment', '生产设备管理', '/admin/sys/equipment/list-ui', '10', '3', 8, '0', 'user:add', 'fa fa-server', '', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_menu` VALUES ('109', 'processunit', '加工单元管理', '/admin/sys/processunit/list-ui', '10', '3', 9, '0', 'user:add', 'fa fa-cubes', '', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');

-- ----------------------------
-- Table structure for sp_sys_equipment
-- ----------------------------
...
-- ----------------------------
-- Table structure for sp_sys_process_unit
-- ----------------------------
...
-- ----------------------------
-- Table structure for sp_material_info
-- ----------------------------
...
CREATE TABLE `sp_material_info` (
  ...
  `update_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '最后更新人',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_sp_material_info_code`(`code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '物料信息定义表' ROW_FORMAT = Dynamic;

INSERT INTO `sp_sys_menu` VALUES ('132', 'materialinfo', '物料信息定义', '/basedata/materialinfo/list-ui', '13', '3', 2, '0', 'user:add', 'fa fa-list-alt', '', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');

INSERT INTO `sp_sys_dict` VALUES ('13390001', '原材料', '1', 'material_type', '物料类型-原材料', 1, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390002', '半成品', '2', 'material_type', '物料类型-半成品', 2, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390003', '成品', '3', 'material_type', '物料类型-成品', 3, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390004', '辅料', '4', 'material_type', '物料类型-辅料', 4, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390005', '自制', '1', 'material_source', '物料来源-自制', 1, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390006', '外购', '2', 'material_source', '物料来源-外购', 2, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390007', '委外', '3', 'material_source', '物料来源-委外', 3, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390008', '钢材', '1', 'material_texture', '材质-钢材', 1, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390009', '铝材', '2', 'material_texture', '材质-铝材', 2, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390010', '铜材', '3', 'material_texture', '材质-铜材', 3, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390011', '塑料', '4', 'material_texture', '材质-塑料', 4, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390012', '橡胶', '5', 'material_texture', '材质-橡胶', 5, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
INSERT INTO `sp_sys_dict` VALUES ('13390013', '复合材料', '6', 'material_texture', '材质-复合材料', 6, '0', '0', '2026-05-24 10:00:00', 'admin', '2026-05-24 10:00:00', 'admin');
