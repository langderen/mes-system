...
DROP TABLE IF EXISTS `sp_flow_definition`;
DROP TABLE IF EXISTS `sp_flow_form`;
DROP TABLE IF EXISTS `sp_flow_oper_relation`;
DROP TABLE IF EXISTS `sp_inbound_application`;
DROP TABLE IF EXISTS `sp_inbound_order`;
DROP TABLE IF EXISTS `sp_inbound_order_item`;
DROP TABLE IF EXISTS `sp_line`;
DROP TABLE IF EXISTS `sp_material_info`;
...
DROP TABLE IF EXISTS `sp_planned_inbound`;
DROP TABLE IF EXISTS `sp_process_content`;
DROP TABLE IF EXISTS `sp_process_material`;
DROP TABLE IF EXISTS `sp_product_bom`;
DROP TABLE IF EXISTS `sp_product_bom_item`;
DROP TABLE IF EXISTS `sp_production_plan`;
DROP TABLE IF EXISTS `sp_production_team`;
DROP TABLE IF EXISTS `sp_qc_activity`;
DROP TABLE IF EXISTS `sp_qc_inspection_data`;
DROP TABLE IF EXISTS `sp_qc_inspection_def`;
DROP TABLE IF EXISTS `sp_qc_inspection_plan`;
DROP TABLE IF EXISTS `sp_qc_inspection_record`;
DROP TABLE IF EXISTS `sp_qc_inspection_task`;
DROP TABLE IF EXISTS `sp_qc_resource`;
DROP TABLE IF EXISTS `sp_sys_department`;
DROP TABLE IF EXISTS `sp_sys_dict`;
DROP TABLE IF EXISTS `sp_sys_equipment`;
DROP TABLE IF EXISTS `sp_sys_equipment_group`;
DROP TABLE IF EXISTS `sp_sys_equipment_group_equipment`;
DROP TABLE IF EXISTS `sp_sys_group`;
DROP TABLE IF EXISTS `sp_sys_group_user`;
DROP TABLE IF EXISTS `sp_sys_menu`;
DROP TABLE IF EXISTS `sp_sys_process_unit`;
...
COMMIT;
BEGIN;
LOCK TABLES `sp_inbound_application` WRITE;
DELETE FROM `sp_inbound_application`;
INSERT INTO `sp_inbound_application` (`id`,`application_code`,`mrp_code`,`order_code`,`product_code`,`product_name`,`total_qty`,`supplier_code`,`supplier_name`,`expected_delivery_date`,`warehouse_id`,`warehouse_name`,`status`,`remark`,`is_deleted`,`create_time`,`create_username`,`update_time`,`update_username`) VALUES ('1760000000000000021', 'INB-20260526140000', 'MRP-20260526-HC001', 'WO-20260524-001', 'PRD-001', '成品A', 1100.00, 'SUP-001', '钢材供应商A', '2026-05-28 08:00:00', 'WH-001', '原料仓A区', 'pending', NULL, '0', '2026-05-27 19:05:37', 'admin', '2026-05-27 19:05:37', 'admin')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `sp_inbound_order` WRITE;
DELETE FROM `sp_inbound_order`;
INSERT INTO `sp_inbound_order` (`id`,`inbound_no`,`source_mrp_nos`,`status`,`item_count`,`total_demand_qty`,`remark`,`is_deleted`,`warehouse_id`,`warehouse_location_id`,`create_time`,`create_username`,`update_time`,`update_username`) VALUES ('2060196743307329538', 'IB-20260529110914', 'MRP-20260529104028,MRP-20260529104028,MRP-20260529104028', 'confirmed', 3, 936.0000, NULL, '0', 'wh001', 'loc001', '2026-05-29 11:09:15', 'admin', '2026-05-29 11:09:58', 'admin')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `sp_inbound_order_item` WRITE;
DELETE FROM `sp_inbound_order_item`;
INSERT INTO `sp_inbound_order_item` (`id`,`inbound_order_id`,`source_mrp_record_id`,`mrp_no`,`order_code`,`bom_code`,`product_code`,`product_name`,`part_code`,`part_name`,`demand_qty`,`unit`,`is_deleted`,`create_time`,`create_username`,`update_time`,`update_username`) VALUES ('2060196743340883970', '2060196743307329538', '2060189500625166337', 'MRP-20260529104028', '324324', '12', '1', '电脑', '101', '玻璃板', 234.0000, '', '0', '2026-05-29 11:09:15', 'admin', '2026-05-29 11:09:15', 'admin'),('2060196743345078273', '2060196743307329538', '2060189500629360642', 'MRP-20260529104028', '324324', '12', '1', '电脑', '102', '铁板', 468.0000, '', '0', '2026-05-29 11:09:15', 'admin', '2026-05-29 11:09:15', 'admin'),('2060196743349272578', '2060196743307329538', '2060189500629360643', 'MRP-20260529104028', '324324', '12', '1', '电脑', '103', 'CPU', 234.0000, '个', '0', '2026-05-29 11:09:15', 'admin', '2026-05-29 11:09:15', 'admin')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
