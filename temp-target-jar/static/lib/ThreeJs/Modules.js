...
function initMat() {
    ...
    new THREE.TextureLoader().load( '/lib/ThreeJs/images/plane.png', function( map ) {
        planeMat.map = map;
        planeMat.transparent = true;
        planeMat.opacity = 0.8;
        planeMat.needsUpdate = true;
    } );
    new THREE.TextureLoader().load( "/lib/ThreeJs/images/rack.png", function( map ) {
        RackMat.map = map;
        RackMat.needsUpdate = true;
    } );
    new THREE.TextureLoader().load( "/lib/ThreeJs/images/box.png", function( map ) {
        CargoMat.map = map;
        CargoMat.needsUpdate = true;
    } );
    new THREE.TextureLoader().load( "/lib/ThreeJs/images/line.png", function( map ) {
        LineMat.map = map;
        LineMat.needsUpdate = true;
    } );
    RollTexture = new THREE.TextureLoader().load( "/lib/ThreeJs/images/biaoyu.png", function( map ) {
        RollMat.map = map;
...
function addSkybox( size,scene ) {
    urls = [
        '/lib/ThreeJs/images/skybox/远山_RT.jpg', // right
        '/lib/ThreeJs/images/skybox/远山_LF.jpg', // left
        '/lib/ThreeJs/images/skybox/远山_UP.jpg', // top
        '/lib/ThreeJs/images/skybox/远山_DN.jpg', // bottom
        '/lib/ThreeJs/images/skybox/远山_BK.jpg', // back
        '/lib/ThreeJs/images/skybox/远山_FR.jpg'  // front
    ];
